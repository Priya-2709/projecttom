...
<html>
  <head>
    ...
    <title>HEENA IS VERY INNOCENT?</title>
  </head>
  ...
  <body>
    ...
    <div id="hate" class="container snakes snake-hater">
      <h1 class="cover-heading">WELCOME TO PRIYA'S PROJECT !</h1>
      <p class="lead">THIS IS A JAVA WEBPAGE</p>
      <!--Intro -->
      <h2>KEERTHI IS PRIYA'S FRND:)</h2>
